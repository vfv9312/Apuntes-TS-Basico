...
let hexadecimal:number = 0xfff; //los hexadecimales se consideran como number
console.log('hex', hexadecimal);

let binario:number = 0b1010; //los binarios son aceptados como number para declarar comienza en 0b y luego solo 1 y 0
console.log('bin', binario); // en binario 1010 es 10

const myNumber: Number = 10; //no usar Number debdido a que se usa en otras cosas
